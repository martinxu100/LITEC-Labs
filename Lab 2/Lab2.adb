...
F:G$Mode_1$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Mode_2$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Mode_3$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$randLED$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Mode_3_Run$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$turnOff$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$blink_time$0$0({2}SI:U),E,0,0
S:G$blink_counts$0$0({2}SI:U),E,0,0
S:G$player1press$0$0({2}SI:U),E,0,0
S:G$player2press$0$0({2}SI:U),E,0,0
S:G$Mode2Rounds$0$0({2}SI:U),E,0,0
S:G$instant_lose$0$0({2}SI:U),E,0,0
S:G$startLED$0$0({2}SI:U),E,0,0
S:G$player1turn$0$0({2}SI:U),E,0,0
S:G$player1blink$0$0({2}SI:U),E,0,0
S:G$player2blink$0$0({2}SI:U),E,0,0
S:G$Mode3Rounds$0$0({2}SI:U),E,0,0
S:G$debounce_time$0$0({2}SI:U),E,0,0
...
S:FLab2$__str_0$0$0({24}DA24d,SC:S),D,0,0
S:FLab2$__str_1$0$0({24}DA24d,SC:S),D,0,0
S:FLab2$__str_2$0$0({18}DA18d,SC:S),D,0,0
S:FLab2$__str_3$0$0({18}DA18d,SC:S),D,0,0
S:FLab2$__str_4$0$0({8}DA8d,SC:S),D,0,0
S:FLab2$__str_5$0$0({62}DA62d,SC:S),D,0,0
S:FLab2$__str_6$0$0({62}DA62d,SC:S),D,0,0
S:FLab2$__str_7$0$0({23}DA23d,SC:S),D,0,0
S:FLab2$__str_8$0$0({23}DA23d,SC:S),D,0,0
