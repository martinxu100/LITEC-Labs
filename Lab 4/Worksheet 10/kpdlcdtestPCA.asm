...
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:37: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$kpdlcdtestPCA.c$40$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:40: Sys_Init();     // System Initialization - MUST BE 1st EXECUTABLE STATEMENT
	lcall	_Sys_Init
	C$kpdlcdtestPCA.c$41$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:41: Port_Init();    // Initialize ports 2 and 3 - XBR0 set to 0x05, UART0 & SMB
	lcall	_Port_Init
	C$kpdlcdtestPCA.c$42$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:42: Interrupt_Init();   // You may want to change XBR0 to match your SMB wiring
	lcall	_Interrupt_Init
	C$kpdlcdtestPCA.c$43$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:43: PCA_Init();
	lcall	_PCA_Init
	C$kpdlcdtestPCA.c$44$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:44: SMB0_Init();
	lcall	_SMB0_Init
	C$kpdlcdtestPCA.c$45$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:45: putchar('\r');  // Dummy write to serial port
	mov	dpl,#0x0d
	lcall	_putchar
	C$kpdlcdtestPCA.c$46$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:46: printf("\nStart\r\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:48: Counts = 0;
	clr	a
	mov	_Counts,a
	mov	(_Counts + 1),a
	C$kpdlcdtestPCA.c$49$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:49: while (Counts < 1); // Wait a long time (1s) for keypad & LCD to initialize
00101$:
	clr	c
	mov	a,_Counts
	subb	a,#0x01
...
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:51: lcd_clear();
	lcall	_lcd_clear
	C$kpdlcdtestPCA.c$52$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:52: lcd_print("Calibration:\nHello world!\n012_345_678:\nabc def ghij");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
...
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:53: while (1)
00109$:
	C$kpdlcdtestPCA.c$55$2$123 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:55: keypad = read_keypad();
	lcall	_read_keypad
	mov	r7,dpl
	C$kpdlcdtestPCA.c$56$2$123 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:56: pause();    // This pauses for 1 PCA0 counter clock cycle (20ms) 
	push	ar7
	lcall	_pause
	pop	ar7
	C$kpdlcdtestPCA.c$59$2$123 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:59: if (keypad != 0xFF)   // keypad = 0xFF if no key is pressed
	cjne	r7,#0xff,00129$
	sjmp	00109$
00129$:
	C$kpdlcdtestPCA.c$63$3$124 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:63: lcd_clear();
	push	ar7
	lcall	_lcd_clear
	pop	ar7
	C$kpdlcdtestPCA.c$64$3$124 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:64: lcd_print("Your key was: %c, = Hex %X, = Decimal %u \r\n", keypad, keypad, keypad);
	mov	ar5,r7
	mov	r6,#0x00
	push	ar7
	push	ar6
	...
	pop	ar5
	pop	ar6
	C$kpdlcdtestPCA.c$65$3$124 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:65: printf("Your key was: %c, = Hex %X, = Decimal %u \r\n", keypad, keypad, keypad);
	push	ar5
	push	ar6
	push	ar5
	push	ar6
	...
	mov	sp,a
	pop	ar7
	C$kpdlcdtestPCA.c$66$3$124 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:66: if(keypad == 0)printf("   **Wire Connection/XBR0 Error**   ");
	mov	a,r7
	jnz	00109$
	mov	a,#___str_6
	push	acc
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$kpdlcdtestPCA.c$72$1$122 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:72: void Port_Init(void)	//0x05
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$kpdlcdtestPCA.c$74$1$126 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:74: XBR0 = 0x27;    // NOTE: Only UART0 & SMB enabled; SMB on P0.2 & P0.3
	mov	_XBR0,#0x27
	C$kpdlcdtestPCA.c$75$1$126 ==.
	XG$Port_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$kpdlcdtestPCA.c$77$1$126 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:77: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$kpdlcdtestPCA.c$79$1$128 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:79: IE |= 0x02;
	orl	_IE,#0x02
	C$kpdlcdtestPCA.c$80$1$128 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:80: EIE1 |= 0x08;
	orl	_EIE1,#0x08
	C$kpdlcdtestPCA.c$81$1$128 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:81: EA = 1;
	setb	_EA
	C$kpdlcdtestPCA.c$82$1$128 ==.
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$kpdlcdtestPCA.c$84$1$128 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:84: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$kpdlcdtestPCA.c$86$1$130 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:86: PCA0MD = 0x81;      // SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$kpdlcdtestPCA.c$88$1$130 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:88: PCA0CN |= 0x40;     // enable PCA
	orl	_PCA0CN,#0x40
	C$kpdlcdtestPCA.c$89$1$130 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMB0_Init$0$0 ==.
	C$kpdlcdtestPCA.c$91$1$130 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:91: void SMB0_Init(void)    // This was at the top, moved it here to call wait()
;	-----------------------------------------
;	 function SMB0_Init
;	-----------------------------------------
_SMB0_Init:
	C$kpdlcdtestPCA.c$93$1$132 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:93: SMB0CR = 0x93;      // Set SCL to 100KHz
	mov	_SMB0CR,#0x93
	C$kpdlcdtestPCA.c$94$1$132 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:94: ENSMB = 1;          // Enable SMBUS0
	setb	_ENSMB
	C$kpdlcdtestPCA.c$95$1$132 ==.
	XG$SMB0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$kpdlcdtestPCA.c$97$1$132 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:97: void PCA_ISR(void) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	push	acc
	push	psw
	C$kpdlcdtestPCA.c$99$1$134 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:99: if (CF)
	C$kpdlcdtestPCA.c$101$2$135 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:101: CF = 0;                     // clear the interrupt flag
	jbc	_CF,00114$
	sjmp	00104$
00114$:
	C$kpdlcdtestPCA.c$102$2$135 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:102: nOverflows++;               // continuous overflow counter
	inc	_nOverflows
	clr	a
	cjne	a,_nOverflows,00115$
	inc	(_nOverflows + 1)
00115$:
	C$kpdlcdtestPCA.c$103$2$135 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:103: nCounts++;
	inc	_nCounts
	clr	a
	cjne	a,_nCounts,00116$
	inc	(_nCounts + 1)
00116$:
	C$kpdlcdtestPCA.c$104$2$135 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:104: PCA0L = PCA_START & 0xFF;   // low byte of start count
	mov	_PCA0L,#0x00
	C$kpdlcdtestPCA.c$105$2$135 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:105: PCA0H = PCA_START >> 8;     // high byte of start count
	mov	_PCA0H,#0x70
	C$kpdlcdtestPCA.c$106$2$135 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:106: if (nCounts > 50)
	clr	c
	mov	a,#0x32
	subb	a,_nCounts
	clr	a
	subb	a,(_nCounts + 1)
	jnc	00106$
	C$kpdlcdtestPCA.c$108$3$136 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:108: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$109$3$136 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:109: Counts++;               // seconds counter
	inc	_Counts
;	genFromRTrack removed	clr	a
	...
	sjmp	00106$
00104$:
	C$kpdlcdtestPCA.c$112$1$134 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:112: else PCA0CN &= 0xC0;           // clear all other 9-type interrupts
	anl	_PCA0CN,#0xc0
00106$:
	pop	psw
	pop	acc
	C$kpdlcdtestPCA.c$113$1$134 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;------------------------------------------------------------
	G$pause$0$0 ==.
	C$kpdlcdtestPCA.c$115$1$134 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:115: void pause(void)
;	-----------------------------------------
;	 function pause
;	-----------------------------------------
_pause:
	C$kpdlcdtestPCA.c$117$1$138 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:117: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$118$1$138 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:118: while (nCounts < 1);// 1 count -> (65536-PCA_START) x 12/22118400 = 20ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x01
...
;------------------------------------------------------------
	G$wait$0$0 ==.
	C$kpdlcdtestPCA.c$121$1$138 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:121: void wait(void)
;	-----------------------------------------
;	 function wait
;	-----------------------------------------
_wait:
	C$kpdlcdtestPCA.c$123$1$140 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:123: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$124$1$140 ==.
;	C:\Users\XuMartin\OneDrive2\OneDrive - Rensselaer Polytechnic Institute\1. LITEC\Labs\Lab 4\kpdlcdtestPCA.c:124: while (nCounts < 50);    // 50 counts -> 50 x 20ms = 1000ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x32
