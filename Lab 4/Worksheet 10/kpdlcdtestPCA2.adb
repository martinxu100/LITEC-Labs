...
S:LkpdlcdtestPCA2.lcd_print$fmt$1$80({3}DG,SC:U),B,1,-5
S:LkpdlcdtestPCA2.lcd_print$len$1$81({1}SC:U),R,0,0,[r6]
S:LkpdlcdtestPCA2.lcd_print$i$1$81({1}SC:U),R,0,0,[]
S:LkpdlcdtestPCA2.lcd_print$ap$1$81({1}DD,SC:U),R,0,0,[]
...
S:LkpdlcdtestPCA2.getchar$c$1$43({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA2.getchar_nw$c$1$45({1}SC:U),R,0,0,[]
S:G$Data2$0$0({3}DA3d,SC:U),E,0,0
S:LkpdlcdtestPCA2.lcd_clear$NumBytes$1$85({1}SC:U),E,0,0
S:LkpdlcdtestPCA2.lcd_clear$Cmd$1$85({2}DA2d,SC:U),E,0,0
S:LkpdlcdtestPCA2.read_keypad$i$1$86({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA2.read_keypad$Data$1$86({2}DA2d,SC:U),E,0,0
S:LkpdlcdtestPCA2.kpd_input$mode$1$88({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA2.kpd_input$sum$1$89({2}SI:U),R,0,0,[r5,r6]
S:LkpdlcdtestPCA2.kpd_input$key$1$89({1}SC:U),R,0,0,[r3]
S:LkpdlcdtestPCA2.kpd_input$i$1$89({1}SC:U),R,0,0,[]
S:LkpdlcdtestPCA2.i2c_write_data$start_reg$1$105({1}SC:U),E,0,0
S:LkpdlcdtestPCA2.i2c_write_data$buffer$1$105({3}DG,SC:U),E,0,0
S:LkpdlcdtestPCA2.i2c_write_data$num_bytes$1$105({1}SC:U),E,0,0
S:LkpdlcdtestPCA2.i2c_write_data$addr$1$105({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA2.i2c_write_data$i$1$106({1}SC:U),R,0,0,[]
S:LkpdlcdtestPCA2.i2c_read_data$start_reg$1$107({1}SC:U),E,0,0
S:LkpdlcdtestPCA2.i2c_read_data$buffer$1$107({3}DG,SC:U),E,0,0
S:LkpdlcdtestPCA2.i2c_read_data$num_bytes$1$107({1}SC:U),E,0,0
S:LkpdlcdtestPCA2.i2c_read_data$addr$1$107({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA2.i2c_read_data$j$1$108({1}SC:U),R,0,0,[]
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$nCounts$0$0({2}SI:U),E,0,0
S:G$nOverflows$0$0({2}SI:U),E,0,0
S:LkpdlcdtestPCA2.main$keypad$1$122({1}SC:U),R,0,0,[r6]
S:LkpdlcdtestPCA2.lcd_print$text$1$81({80}DA80d,SC:U),F,0,0
...
S:FkpdlcdtestPCA2$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FkpdlcdtestPCA2$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FkpdlcdtestPCA2$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FkpdlcdtestPCA2$__str_3$0$0({9}DA9d,SC:S),D,0,0
S:FkpdlcdtestPCA2$__str_4$0$0({52}DA52d,SC:S),D,0,0
S:FkpdlcdtestPCA2$__str_5$0$0({44}DA44d,SC:S),D,0,0
S:FkpdlcdtestPCA2$__str_6$0$0({37}DA37d,SC:S),D,0,0
