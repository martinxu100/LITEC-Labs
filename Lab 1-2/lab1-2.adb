...
S:Llab1_2.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:Llab1_2.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$old$0$0({2}SI:U),E,0,0
S:G$randomnum$0$0({2}SI:U),E,0,0
S:G$correct$0$0({2}SI:U),E,0,0
S:G$turns$0$0({2}SI:U),E,0,0
S:G$correctresponse$0$0({2}SI:U),E,0,0
S:Llab1_2.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:Llab1_2.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
...
S:Flab1_2$__str_1$0$0({32}DA32d,SC:S),D,0,0
