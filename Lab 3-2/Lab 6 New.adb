...
S:LLab_6_New.lcd_print$fmt$1$80({3}DG,SC:U),B,1,-5
S:LLab_6_New.lcd_print$len$1$81({1}SC:U),R,0,0,[r6]
S:LLab_6_New.lcd_print$i$1$81({1}SC:U),R,0,0,[]
S:LLab_6_New.lcd_print$ap$1$81({1}DD,SC:U),R,0,0,[]
...
F:G$setAngle$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ReadRanger$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ReadCompass$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$errHeading1$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$errHeading2$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$errHeading3$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$getGain$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$getHeading$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$printData$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
T:FLab_6_New$float_long[({0}S:S$f$0$0({4}SF:S),Z,0,0)({0}S:S$l$0$0({4}SL:S),Z,0,0)]
S:LLab_6_New.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:LLab_6_New.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Data2$0$0({3}DA3d,SC:U),E,0,0
S:LLab_6_New.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:LLab_6_New.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:LLab_6_New.lcd_clear$NumBytes$1$85({1}SC:U),E,0,0
S:LLab_6_New.lcd_clear$Cmd$1$85({2}DA2d,SC:U),E,0,0
S:LLab_6_New.read_keypad$i$1$86({1}SC:U),R,0,0,[r7]
S:LLab_6_New.read_keypad$Data$1$86({2}DA2d,SC:U),E,0,0
S:LLab_6_New.kpd_input$mode$1$88({1}SC:U),R,0,0,[r7]
S:LLab_6_New.kpd_input$sum$1$89({2}SI:U),R,0,0,[r5,r6]
S:LLab_6_New.kpd_input$key$1$89({1}SC:U),R,0,0,[r3]
S:LLab_6_New.kpd_input$i$1$89({1}SC:U),R,0,0,[]
S:LLab_6_New.i2c_write_data$start_reg$1$105({1}SC:U),E,0,0
S:LLab_6_New.i2c_write_data$buffer$1$105({3}DG,SC:U),E,0,0
S:LLab_6_New.i2c_write_data$num_bytes$1$105({1}SC:U),E,0,0
S:LLab_6_New.i2c_write_data$addr$1$105({1}SC:U),R,0,0,[r7]
S:LLab_6_New.i2c_write_data$i$1$106({1}SC:U),R,0,0,[]
S:LLab_6_New.i2c_read_data$start_reg$1$107({1}SC:U),E,0,0
S:LLab_6_New.i2c_read_data$buffer$1$107({3}DG,SC:U),E,0,0
S:LLab_6_New.i2c_read_data$num_bytes$1$107({1}SC:U),E,0,0
S:LLab_6_New.i2c_read_data$addr$1$107({1}SC:U),R,0,0,[r7]
S:LLab_6_New.i2c_read_data$j$1$108({1}SC:U),R,0,0,[]
S:G$dr_input_data$0$0({1}DA1d,SC:U),E,0,0
S:G$distance$0$0({2}SI:U),E,0,0
S:G$ranger_count$0$0({1}SC:U),E,0,0
...
S:G$printcounts$0$0({1}SC:U),E,0,0
...
S:G$pk$0$0({2}SI:S),E,0,0
S:G$dk$0$0({2}SI:S),E,0,0
S:G$temp_pw$0$0({2}SI:S),E,0,0
S:G$angle$0$0({2}SI:S),E,0,0
S:LLab_6_New.ReadRanger$addr$2$168({1}SC:U),R,0,0,[]
S:LLab_6_New.ReadRanger$dr_data_array$2$168({2}DA2d,SC:U),E,0,0
S:LLab_6_New.ReadCompass$addr$2$171({1}SC:U),R,0,0,[]
S:LLab_6_New.ReadCompass$Data$2$171({2}DA2d,SC:U),E,0,0
S:LLab_6_New.lcd_print$text$1$81({80}DA80d,SC:U),F,0,0
...
S:G$DS0$0$0({1}SX:U),J,0,0
S:G$DS1$0$0({1}SX:U),J,0,0
S:G$DS2$0$0({1}SX:U),J,0,0
S:G$DS3$0$0({1}SX:U),J,0,0
S:G$DS4$0$0({1}SX:U),J,0,0
S:G$DS5$0$0({1}SX:U),J,0,0
S:G$DS6$0$0({1}SX:U),J,0,0
S:G$DS7$0$0({1}SX:U),J,0,0
S:G$BAT$0$0({1}SX:U),J,0,0
...
S:G$Set_DrivePulsewidth$0$0({2}DF,SV:S),C,0,0
S:G$errHeading$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:FLab_6_New$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLab_6_New$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLab_6_New$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLab_6_New$__str_3$0$0({27}DA27d,SC:S),D,0,0
S:FLab_6_New$__str_4$0$0({25}DA25d,SC:S),D,0,0
S:FLab_6_New$__str_5$0$0({25}DA25d,SC:S),D,0,0
S:FLab_6_New$__str_6$0$0({23}DA23d,SC:S),D,0,0
S:FLab_6_New$__str_7$0$0({17}DA17d,SC:S),D,0,0
S:FLab_6_New$__str_8$0$0({23}DA23d,SC:S),D,0,0
S:FLab_6_New$__str_9$0$0({118}DA118d,SC:S),D,0,0
S:FLab_6_New$__str_10$0$0({55}DA55d,SC:S),D,0,0
